...
<details>   <summary>Click to view JSON data</summary>    ```json   {     "name": "John Doe",     "age": 30,     "city": "New York",     "email": "john.doe@example.com",     "preferences": {       "newsletter": true,       "notifications": false     }   }